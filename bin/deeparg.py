...
arg=pd.read_csv(sys.argv[1], sep='\t', index_col=0, header=None, names=["read_ID", "db_id", "features", "db", "drug", "arg","pident", "alignmentlength", "mismatch", "gapopen", "qstart", "qend", "sstart", "send", "evalue", "bitscore", "qcovhsp"])
